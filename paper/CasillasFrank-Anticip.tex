...
Because the form of an answer is partially determined by its question (e.g., locative expressions for ``where'' questions), participants could even be predicting what type of response they will hear, and so they are looking anticipatorily at the responder for confirmation of their prediction. This interpretation is initial, but in-line with work showing early response planning and speech act recognition \citep{gisladottir2015, bogels2015}.



\subsubsection{Early competence for turn taking?}
% When does children's performance become adult-like?

Though children's anticipatory gazes did show some gains with age, adults on average still made more anticipatory switches than children in all conditions, even compared to 6-year-olds. Curiously, child and adult performance were much more similar by ages 3--5 in Experiment 1. This may indicate that children rely more in non-verbal cues in anticipating turn transitions or, alternatively, that adults are better at flexibly adapting to the turn-relevant cues present at any moment.
...
% assumptions about saccadic planning time
% There is a problem with manipulated speech
